...
//				System.out.println(((TLTileCodingFeatures)vfa.sparseStateFeatures).getTransferCovering());
	...
	public static void main(String[] args) {
		...
		//SOURCE
		GridWorldTransferLearning source = new GridWorldTransferLearning(new GridWorldTransferLearning_UTILS().gwdf_test_L, 4);
		...
		//SOURCE 2
		GridWorldTransferLearning source2 = new GridWorldTransferLearning(new GridWorldTransferLearning_UTILS().gwdf_treasure, 4);
		
		int nEpochs_source2 = 1;
		int nEpisodes_source2 = 50;
		...
		//TARGET
		GridWorldTransferLearning target = new GridWorldTransferLearning(new GridWorldTransferLearning_UTILS().gwdf_test_L, 4);
		
		int nEpochs_target = 1;
		int nEpisodes_target = 100;
		...
		//TARGET NO TRANSFER
		GridWorldTransferLearning targetNoTransfer = new GridWorldTransferLearning(new GridWorldTransferLearning_UTILS().gwdf_test_L, 12);
		
		int nEpochs_targetNoTransfer = 1;
		int nEpisodes_targetNoTransfer = 100;
		
		TLLinearVFA targetVFANoTransfer =  targetNoTransfer.PerformLearningAlgorithm("GridWorldTest/targetNoTransfer/", 2, nEpochs_targetNoTransfer, nEpisodes_targetNoTransfer, null);
		
		targetNoTransfer.visualize("GridWorldTest/targetNoTransfer/");
	}
